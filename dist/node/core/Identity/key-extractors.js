...
function getVerificationKeyFromDifferentFormats(method, holder) {
    ...
    if (method.publicKeyJwk) {
        ...
        holder.format = globals_1.KEY_FORMATS.BASE58;
        holder.publicKey = Utils_1.getBase58fromMultibase(method.publicKeyMultibase);
    }
    else {
        throw new Error(commons_1.ERRORS.UNSUPPORTED_KEY_FORMAT);
    }
...
var ed25519VerificationKeyExtractor = new Ed25519VerificationKeyExtractor(['Ed25519VerificationKey2018', 'Ed25519VerificationKey2020', 'ED25519SignatureVerification'], jwsVerificationKey2020Extractor);
