        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                if (rp.request_uri) {
                    ...
                    jwtPayload = __assign({ iss: rp.did, response_type: 'id_token', scope: 'openid did_authn', client_id: rp.did, redirect_uri: rp.redirect_uri, registration: rp.registration }, options);
                    jwtObject = {
                        header: jwtHeader,
                        payload: jwtPayload
                    };
