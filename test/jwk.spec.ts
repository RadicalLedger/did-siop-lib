import { KeySet, checkKeyPair } from './../src/JWKUtils';
...
describe('Keypair', function (){
    test('checkKeyPair function', async ()=>{
        ...
        let validity = checkKeyPair(privateKey, publicKey, ALGORITHMS.RS256);
        expect(validity).toBeTruthy();
        ...
        validity = checkKeyPair(privateKey, publicKey, ALGORITHMS.ES256K);
        expect(validity).toBeTruthy();
        ...
        validity = checkKeyPair(privateKey, publicKey, ALGORITHMS["ES256K-R"]);
        expect(validity).toBeTruthy();
        ...
        validity = checkKeyPair(privateKey, publicKey, ALGORITHMS.EdDSA);
        expect(validity).toBeTruthy();
    })
});
