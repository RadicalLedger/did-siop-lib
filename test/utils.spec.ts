...
describe('Utils', function (){
    test('checkKeyPair function', async ()=>{
        ...
        let validity = checkKeyPair(privateKey, publicKey, new RSASigner(), new RSAVerifier(), ALGORITHMS.RS256);
        ...
        validity = checkKeyPair(privateKey, publicKey, new ECSigner(), new ECVerifier(), ALGORITHMS.ES256K);
        expect(validity).toBeTruthy();
        ...
        validity = checkKeyPair(privateKey, publicKey, new ES256KRecoverableSigner(), new ES256KRecoverableVerifier(), ALGORITHMS["ES256K-R"]);
        expect(validity).toBeTruthy();
        ...
        validity = checkKeyPair(privateKey, publicKey, new OKPSigner(), new OKPVerifier(), ALGORITHMS.EdDSA);
        expect(validity).toBeTruthy();
    })
});