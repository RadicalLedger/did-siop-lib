    ...
    resolverReturn: {
        ...
        publicKey: [
          {
            ...
            type: "EcdsaSecp256k1VerificationKey2019",
            publicKeyHex:
              "024a63c4362772b0fafc51ac02470dae3f8da8a05d90bae9e1ef3f5243180120dd",
          },
          {
            id: "did:btcr:xkrn-xz7q-qsye-28p#key-1",
            type: "EcdsaSecp256k1VerificationKey2019",
            publicKeyHex:
              "02b5470c5c0557ef7548dec23220d4d75f8c4aa1b459c190f100f4f78a1adb215b",
          },
          {
            id: "did:btcr:xkrn-xz7q-qsye-28p#key-2",
            type: "EcdsaSecp256k1VerificationKey2019",
            publicKeyHex:
              "02e2078417a258acc2c9f9eb856b35b508d1e5a23fc1dcf94fd6f7337b1cb7fb90",
          },
          {
            id: "did:btcr:xkrn-xz7q-qsye-28p#key-3",
            type: "EcdsaSecp256k1VerificationKey2019",
            publicKeyHex:
              "02074f9b37f26ae410742ec754b02b3f7d078ff73d7e06b6f7a670d5701805ef82",
          },
          {
            id: "did:btcr:xkrn-xz7q-qsye-28p#key-4",
            type: "EcdsaSecp256k1VerificationKey2019",
            publicKeyHex:
              "02b4021b6907fbc12b2c0d9278d21bc0f371a56b553fc75eaf75b79d925301f7a4",
          },
          {
            id: "did:btcr:xkrn-xz7q-qsye-28p#key-5",
            type: "EcdsaSecp256k1VerificationKey2019",
            publicKeyHex:
              "03479e1bde881c15edc82b7c4d0d04441c5e7f6dce4b703f43c5d5c12948df32d2",
          },
          {
      ...
      methodMetadata: {
        inputScriptPubKey:
          "03479e1bde881c15edc82b7c4d0d04441c5e7f6dce4b703f43c5d5c12948df32d2",
        continuationUri:
          "https://raw.githubusercontent.com/peacekeeper/self/master/ddo",
        continuation: {
          "@context": "https://www.w3.org/2019/did/v1",
          id: "did:btcr:xkrn-xz7q-qsye-28p",
        },
        ...
        publicKey: [
          {
            ...
            type: "EcdsaSecp256k1VerificationKey2019",
            publicKeyHex:
              "03aa0d1f6177a7f27dfabe51b1442057ca1bf9bede4f857d92203a165302834693",
          },
          {
    ...
    resolverReturn: {
        ...
        publicKey: [
          {
            ...
            type: "Secp256k1",
            publicKeyHex:
              "046fcbedd1107ca45be3e81fc445e5a366886a89e7087fe3d128e6236302f31594740f250433ebe9f0abcbd04dbf9c5979e270a0772ad1cc502cec2d5de9504c8c",
          },
          {
            id: "did:ccp:ceNobbK6Me9F5zwyE3MKY88QZLw#key-2",
            type: "Secp256k1",
            publicKeyHex:
              "0496712d16b0836684aacd5ab6ba3d489c35efa31f414a1c6a455fc6b37ff28e5fa97ac29c1021b76e5b78e2bbceac1dfc4ec98e6b2b3e65a29f7f1cd4944dfb93",
          },
        ],
      },
      content: null,
      ...
      methodMetadata: {
        ...
        proof: {
          ...
          type: "Secp256k1",
          signatureValue:
            "30440220211ffc76ae2858d6baa29faa9b576d6b2e048e8f4f7767ee1c2fba7ae6c2a78102205f5b56cd1431830b45109d716631638d961e5b252c2c2354d8bb96782d8a62ef",
        },
        ...
        publicKey: [
          {
            ...
            type: "Ed25519VerificationKey2018",
            controller:
              "did:dock:5H7qVySj4cVga4GmiRpvRQqKCVzoWfE4w1DGV5NGVz2umfu2",
      ...
      resolverMetadata: {
        ...
        didUrl: {
          ...
          did: {
            ...
            method: "dock",
            methodSpecificId:
              "5FXqofpV7dsuki925U1dSzDvBuQbaci5yWTQGVWRQ7bdQP5p",
            parseTree: null,
            parseRuleCount: null,
          },
          parameters: null,
      ...
      didDocument: {
        ...
        authentication: [
          "did:elem:ropsten:EiAS3mqC4OLMKOwcz3ItIL7XfWduPT7q3Fa4vHgiCfSG2A#edv",
          {
            ...
            type: "Ed25519VerificationKey2018",
            controller:
              "did:elem:ropsten:EiAS3mqC4OLMKOwcz3ItIL7XfWduPT7q3Fa4vHgiCfSG2A",
        ...
        publicKey: [
          {
            ...
            controller:
              "did:elem:ropsten:EiAS3mqC4OLMKOwcz3ItIL7XfWduPT7q3Fa4vHgiCfSG2A",
            publicKeyHex:
              "0361f286ada2a6b2c74bc6ed44a71ef59fb9dd15eca9283cbe5608aeb516730f33",
          },
          {
  ...
  },
  {
    ...
    resolverReturn: {
      ...
      resolverMetadata: {
        ...
        didUrl: {
          ...
          did: {
            ...
            method: "factom",
            methodSpecificId:
              "testnet:6aa7d4afe4932885b5b6e93accb5f4f6c14bd1827733e05e3324ae392c0b2764",
            parseTree: null,
            parseRuleCount: null,
          },
          parameters: null,
      ...
      methodMetadata: {
        ...
        chainCreationEntryHash:
          "4eb1a96667a5d539b76a91df081e53988c9cdc55f0656aa0a2558ff7fdc922ea",
        resolvedFactomIdentity: {
          ...
          metadata: {
            ...
            update: {
              ...
              blockTimestamp: 1585952520,
              entryHash:
                "1626a1ab198ca2ce973a5876dbfafcbfd098a718d44538b248565ca4d3381225",
            },
          },
        },
        ...
        publicKey: [
          {
            ...
            publicKeyHex:
              "0xb973dbeb639d1ccbe143c3f38e95afbc9951b6bc2bc865ab3fe1fa0dacd92816",
          },
          {
            ...
            controller:
              "did:kilt:5GFs8gCumJcZDDWof5ETFqDFEsNwCsVJUj2bX7y4xBLxN5qT",
            publicKeyHex:
              "0x4a087176d183ff29cb3ddd55f3f804ef2c719232ad71ebd3dc29f47a24d91e7a",
          },
        ],
      },
      content: null,
      ...
      resolverMetadata: {
        ...
        didUrl: {
          ...
          did: {
            ...
            method: "kilt",
            methodSpecificId:
              "5GFs8gCumJcZDDWof5ETFqDFEsNwCsVJUj2bX7y4xBLxN5qT",
            parseTree: null,
            parseRuleCount: null,
          },
          parameters: null,
  ...
  },
  {
    ...
    resolverReturn: {
      didDocument: {
        ...
        authentication: ["did:ont:AN5g6gz9EoQ3sCNu7514GEghZurrktCMiH#keys-1"],
        controller: "",
        publicKey: [
          {
            ...
            publicKeyHex:
              "023b041dfc2d00a9846d291dd4bad3f32b8c13a6ad8dc2e97fd711888ed7818c66",
          },
        ],
      },
      content: null,
        ...
        service: [
          {
            type: "custom",
            serviceEndpoint:
              "https://notary.ownyourdata.eu/?hash=fef73e27304f4f9c17655f1c598b75237664aff67e48a50edc51505a742985cf",
          },
        ],
        authentication: [
          {
            type: "Ed25519SignatureAuthentication2018",
            publicKey: ["did:sov:CYQLsccvwhMTowprMjGjQ6#key-1"],
          },
        ],
        publicKey: [
          {
        ...
        nymResponse: {
          ...
          result: {
            ...
            state_proof: {
              multi_signature: {
                signature:
                  "RH1sUpnJmh4xEoRNrcSukRLq19tACbMuk1Ai6g8RufsyqdCUkoKHJnrbCGTq9yZmXNU61fr4afiqdRc7Bos58H1SJoxuxoxEDpkjHdCQi7fDBzm1LBkB6ReHLTDV7wc9UGHCfqKqzW1qP2AseTYN2N4PLaygEsJy6gX3TQg9E4Mtbq",
                participants: [
                  "findentity",
                  "esatus_AG",
                  "ServerVS",
      ...
      resolverMetadata: {
        ...
        didUrl: {
          ...
          did: {
            ...
            method: "v1",
            methodSpecificId:
              "test:nym:z6MkgF4uJbLMoUin2uKaBf4Jb1F7SHzuALE8Ldq8FPPpHE9t",
            parseTree: null,
            parseRuleCount: null,
          },
          parameters: null,
