...
describe('Signing and verifying with INVALID keys', function () {
    test('RSA sign/verify', async () => {
        let publicJWK: KeyObjects.RSAPublicKeyObject = TD_KEY_PAIRS_INVALID.rsa_1.publicJWK;
        let privateJWK: KeyObjects.RSAPrivateKeyObject = TD_KEY_PAIRS_INVALID.rsa_1.privateJWK;
    ...
    test('EC sign/verify', async () => {
        let publicJWK: KeyObjects.ECPublicKeyObject = TD_KEY_PAIRS_INVALID.ec_1.publicJWK;
        let privateJWK: KeyObjects.ECPrivateKeyObject = TD_KEY_PAIRS_INVALID.ec_1.privateJWK;
    ...
    test('OKP sign/verify', async () => {
        let publicJWK: KeyObjects.OKPPublicKeyObject = TD_KEY_PAIRS_INVALID.okp_1.publicJWK;
        let privateJWK: KeyObjects.OKPPrivateKeyObject = TD_KEY_PAIRS_INVALID.okp_1.privateJWK;
