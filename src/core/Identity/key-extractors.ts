...
export abstract class DidVerificationKeyExtractor {
  ...
  protected next:
    ...
    | EmptyDidVerificationKeyExtractor;
...
class EcdsaSecp256k1RecoveryMethod2020Extractor extends DidVerificationKeyExtractor {
  extract(method: DidVerificationKeyMethod): DidVerificationKey {
    ...
    if (
      this.names.includes(method.type.toUpperCase()) ||
...
const ecdsaSecp256k1VerificationKeyExtractor =
  new EcdsaSecp256k1VerificationKeyExtractor(
    [
...
const ecdsaSecp256r1VerificationKey2019Extractor =
  new EcdsaSecp256r1VerificationKey2019Extractor(
    "EcdsaSecp256r1VerificationKey2019",
    ecdsaSecp256k1VerificationKeyExtractor
  );
const ecdsaSecp256k1RecoveryMethod2020Extractor =
  new EcdsaSecp256k1RecoveryMethod2020Extractor(
